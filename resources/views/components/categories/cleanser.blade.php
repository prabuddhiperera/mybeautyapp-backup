    ...
    <div class="min-h-screen flex flex-col bg-[#ffe8e9]">
        ...
        <section class="max-w-7xl mx-auto px-6 py-6">
            <form method="GET" action="{{ route('categories.cleanser') }}" class="flex flex-wrap gap-4 justify-center">
                ...
                {{-- Search Bar --}}
                <input type="text" name="search" placeholder="Search cleanser products..." 
        ...
        {{-- Product Grid (Hyperpigmentation only) --}}
        <section class="max-w-7xl mx-auto px-6 py-12 flex-1">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                @empty
                    <p class="text-gray-600 col-span-4 text-center">No cleanser products found.</p>
                @endforelse
            </div>
        </section>
