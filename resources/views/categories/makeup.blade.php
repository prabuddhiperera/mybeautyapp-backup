<x-app-layout>
    ...
    <div style="background-color: #ffe8e9;" class="min-h-screen flex flex-col">
        ...
        <div class="w-full">
            <img 
                src="{{ asset('img/makeup-banner.jpg') }}" 
                alt="Makeup Banner" 
        ...
        <section class="max-w-7xl mx-auto px-6 py-6">
            <form method="GET" action="{{ route('categories.makeup') }}" class="flex flex-wrap gap-4 justify-center">
                <input type="text" name="search" placeholder="Search makeup products..." 
        ...
        <section class="max-w-7xl mx-auto px-6 py-12 flex-1">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                @empty
                    <p class="col-span-4 text-center text-gray-600">No products found in this category.</p>
                @endforelse
            </div>
        </section>
